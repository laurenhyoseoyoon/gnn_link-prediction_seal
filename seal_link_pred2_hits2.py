...
# SEAL.
path = 'dataset/train_data' + '_seal{}'.format(args.data_appendix)
...
# train_dataset = torch.load('dataset/train_data.pt')
# test_dataset = torch.load('dataset/ogb_ddi_mid2.pt')
# val_dataset = torch.load('dataset/ogb_ddi_mid2.pt')
